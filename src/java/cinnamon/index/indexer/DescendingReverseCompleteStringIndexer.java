...
/**
 * <p>The ReverseCompleteStringIndexer expects an XPath parameter as searchString and will stored
 ...
 * and stored the <i>raw</i> results of StringBuilder(node.getText()).reverse()</p>
