...
public interface Indexable {
     ...
     * @param withLinks     if applicable, add a "links" node containing a list of links pointing to this object.
     ...
     */
    String getSystemMetadata(Boolean withRelations, Boolean withSummary, Boolean withLinks);
