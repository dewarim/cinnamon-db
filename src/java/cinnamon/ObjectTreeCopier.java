...
public class ObjectTreeCopier {
    ...
    private Map<ObjectSystemData, ObjectSystemData> copyCache
            = new HashMap<ObjectSystemData, ObjectSystemData>();
     ...
     * create empty copies.
     */
    public ObjectTreeCopier(User activeUser, Folder targetFolder, Validator validator, Boolean createFullCopies){
        this(activeUser, targetFolder);
        this.validator = validator;
        this.createFullCopies = createFullCopies;
    }

    public ObjectTreeCopier(User activeUser, Folder targetFolder) {
        em = HibernateSession.getLocalEntityManager();
