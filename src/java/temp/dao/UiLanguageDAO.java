 ...
 *
 */
public interface UiLanguageDAO extends GenericDAO<UiLanguage, Long> {
     ...
     * @return	Language or null if no Language was found.
	 */
	UiLanguage findByIsoCode(String isoCode);
